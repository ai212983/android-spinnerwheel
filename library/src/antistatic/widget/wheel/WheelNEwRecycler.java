 ...
 */
public class WheelNewRecycler {


    @SuppressWarnings("unused")
    private static final String LOG_TAG = WheelNewRecycler.class.getName();
    ...
    // Wheel view
    private WheelNewHorizontalView wheel;

    /**
     * Constructor
     * @param wheel the widget view
     */
    public WheelNewRecycler(WheelNewHorizontalView wheel) {
        this.wheel = wheel;
    }
