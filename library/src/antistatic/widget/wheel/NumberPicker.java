...
/**
 * A wheel that enables the user to select a number form a predefined range.
 * The wheel presents an input filed and up and down buttons for selecting the
 ...
 * scroll widget, tapping on which while shown and not moving allows direct edit
 * of the current value. Sliding motions up or down hide the buttons and the
 * input filed, show the scroll widget, and rotate the latter. Flinging is
 * also supported. The wheel enables mapping from positions to strings such
 * that instead the position index the corresponding string is displayed.
 * <p>
 * For an example of using this wheel, see {@link android.widget.TimePicker}.
 * </p>
 */
...
public class NumberPicker extends LinearLayout {
    ...
    /**
     * The the duration for adjusting the selector widget.
     */
    ...
    /**
     * In this state the selector widget is not shown.
     */
    private static final int SELECTOR_WHEEL_STATE_NONE = 0;

    /**
     * In this state the selector widget is small.
     */
    private static final int SELECTOR_WHEEL_STATE_SMALL = 1;

    /**
     * In this state the selector widget is large.
     */
    private static final int SELECTOR_WHEEL_STATE_LARGE = 2;

    /**
     * The alpha of the selector widget when it is bright.
     */
    ...
    /**
     * The min height of this wheel.
     */
    private int mMinHeight;

    /**
     * The max height of this wheel.
     */
    private final int mMaxHeight;

    /**
     * The max width of this wheel.
     */
    ...
    /**
     * The height of the gap between text elements if the selector widget.
     */
    ...
    /**
     * {@link Animator} for dimming the selector widget.
     */
    ...
    /**
     * Flag if to adjust the selector widget on next up event.
     */
    private boolean mAdjustScrollerOnUpEvent;

    /**
     * The state of the selector widget.
     */
    ...
    /**
     * Flag indicating if this wheel supports flinging.
     */
    ...
    /**
     * Flag whether the scoll widget and the fading edges have been initialized.
     */
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mShowInputControlsAnimimationDuration = 500;
        ...
        // create the selector widget paint
        ...
        mShowInputControlsAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!mCanceled) {
                    // if canceled => we still want the widget drawn
        ...
        if (mFlingable) {
            if (isInEditMode()) {
                ...
                // Start with shown selector widget and hidden controls. When made
    ...
    /**
     * Gets whether the selector widget wraps when reaching the min/max value.
     *
     * @return True if the selector widget wraps.
     *
     * @see #getMinValue()
     * @see #getMaxValue()
     */
    ...
    /**
     * Sets whether the selector widget shown during flinging/scrolling should
     * wrap around the {@link NumberPicker#getMinValue()} and
     * {@link NumberPicker#getMaxValue()} values.
     * <p>
     * By default if the range (max - min) is more than five (the number of
     * items shown on the selector widget) the selector widget wrapping is
     * enabled.
     * </p>
     *
    ...
    protected void onAttachedToWindow() {
        ...
        // first time the user sees this wheel
    ...
    public void draw(Canvas canvas) {
        ...
        // the animation for simultaneously dimming the scroll widget and
        // showing in the buttons. This class takes advantage of the View
        // implementation of fading edges effect to draw the selector widget.
        ...
        // Draw our children if we are not showing the selector widget of fading
        // it out
        if (mShowInputControlsAnimator.isRunning()
    ...
    public void sendAccessibilityEvent(int eventType) {
        ...
        // perceive this wheel as several controls rather as a whole.
    }
